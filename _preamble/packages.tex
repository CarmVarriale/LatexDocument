...
\setlength{\parindent}{0pt} % Add paragraph indentation
...
\setlist[enumerate]{label=\bfseries\textcolor{my-blue}{\arabic*.}}
\setlist[itemize,1]{label=\textcolor{my-blue}{$\blacksquare$}}
\setlist[itemize,2]{label=\textcolor{my-blue}{$\bullet$}}
\setlist[itemize,3]{label=\textcolor{my-blue}{$\diamond$}}
\setlist[itemize,4]{label=\textcolor{my-blue}{$\ast$}}
